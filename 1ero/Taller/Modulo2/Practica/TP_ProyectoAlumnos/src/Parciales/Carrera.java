...
/*
        ...
        y trimestres considerados). Compruebe el correcto funcionamiento de los métodos.F
 */
public abstract class Carrera {

    private String nombre, facultad;
    private int anioComienzo;
    private int dimF, meses = 4;
    private int[][] egresados = new int[dimF][meses];

    public Carrera(String nombre, String facultad, int anioComienzo, int anios) {
        this.nombre = nombre;
    ...
    public void setAnio(int anioComienzo) {
        this.anioComienzo = anioComienzo;
    }
    ...
    public int getEgresados(int anio, int mes) {
        return egresados[anio][mes];
    }

    public void setEgresados(int anio, int mes, int egresados) {
        this.egresados[anio - this.anioComienzo][mes] = egresados;
    }

    @Override
    public String toString() {
        return this.getNombre() + " " + this.getFacultad() + ". Año de creacion" + this.getAnio();
    }
}
